...
public class Sieting extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_sieting);
        ...
        profileChangeTextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                CropImage.activity(imageUri).start(Sieting.this);
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        else
        {
            ...
            startActivity(new Intent(Sieting.this, Sieting.class));
            finish();
        }
    }
                ...
                public Object then(@NonNull Task task) throws Exception
                {
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Uri>() {
                        ...
                        public void onComplete(@NonNull Task<Uri> task)
                        {
                            ...
                            {
                                progressDialog.dismiss();
                                Toast.makeText(Sieting.this, "Error.", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        }
