...
import com.example.mybooks.Model.Cart;
import com.example.mybooks.Prevalent.Prevalent;
import com.example.mybooks.ViewHolder.CartViewHolder;
...
public class CartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        NextProcessBtn.setOnClickListener(new View.OnClickListener() {
            ...
            {
                txtTotalAmount.setText("Total Price =" + String.valueOf(overTotalPrice)+"DT");
